"""
Pose Format Utilities - Converted to PySide6
Handles pose data format conversion between MediaPipe33, Body25, and RR21 formats.
"""
...
def convert_dataframe_to_openpose(pose_data):
    """
    Convert DataFrame to OpenPose JSON format
    """
